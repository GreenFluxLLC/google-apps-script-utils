...
|name|description|
|----|-----------|
|[scripts/Doc Images to Folder/docImgToFolder.js](https://github.com/GreenFluxLLC/google-apps-script-utils/blob/main/scripts/Doc%20Images%20to%20Folder/docImgToFolder.js) | Extracts all image from Doc with sourceId and saves them to folderId (or new folder if not specified)|
